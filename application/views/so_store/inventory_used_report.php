...
<div class="container my-3" style="font-size:small">
  <div style="height:100px">
    <h1><strong>Inventory Used By Project Report</strong></h1>
  ...
  <table class="table table-bordered" style="color:black">
    <thead style="background-color:lightgray">
      <tr>
        ...
        <th><?= $inventory_record['Name'] ?></th>
      </tr>
    </thead>
    <thead>
      <tr>
        <th scope="col"> Material Name:</th>
        <td><?= $inventory_record['Material_Name'] ?></td>
      </tr>
    </thead>
    <thead>
      <tr>
        <th scope="col">Quantity Used</th>
        <td><?= $inventory_record['Quantity_used'] ?></td>
      </tr>
    </thead>
    <thead>
      <tr>
        <th scope="col">Price</th>
        <td><?= $inventory_record['Price'] ?></td>
      </tr>
    </thead>
    <thead>
      <tr>
        <th scope="col">Delivery Date</th>
        <td>PKR. <?= $inventory_record['delivery_date'] ?>/-</td>
      </tr>
    </thead>
        <thead>
      <tr>
