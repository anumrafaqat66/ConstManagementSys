...
<div class="container">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
        ...
        <a onclick="location.href='<?php echo base_url(); ?>SO_STORE/report_inventory_used/<?= $project_data['ID']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
    </div>
