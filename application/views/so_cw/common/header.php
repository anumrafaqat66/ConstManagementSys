    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url(); ?><?php if ($this->session->userdata('acct_type') == 'SO_CW') {
                                                                        echo "SO_CW";
                                                                    } ?>">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo base_url(); ?>SO_CW/view_project_schedule/1"  aria-expanded="true">
                    <i style="font-size:20px" class="fas fa-tasks"></i>
                    <span> Project Tasks </span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo base_url(); ?>SO_CW/view_project_progress/1"  aria-expanded="true">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo base_url(); ?>SO_CW/view_activity_log"  aria-expanded="true">
                ...
                <nav class="navbar navbar-expand navbar-light bg-custom1 topbar static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle text-dark-500" type="button" onclick="location.href='<?php echo base_url(); ?>SO_CW'"> Home </a>
                        </li>
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" type="button" onclick="location.href='<?php echo base_url(); ?>SO_CW/services'">Services </a>
                        </li>
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" type="button" onclick="location.href='<?php echo base_url(); ?>SO_CW/about'">About </a>
                        </li>
