                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card bg-custom3">
                                    <div class="card-header bg-custom1">
                                        <h1 class="h4">Add Performance Security Letter</h1>
                                    </div>

                                    <div class="card-body">

                                        <form class="user" role="form" enctype="multipart/form-data" method="post" id="add_performance_security_form" action="<?= base_url(); ?>SO_RECORD/upload_performance_security_letter">
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4 mb-1">
                                                    <input type="number" class="form-control form-control-user" name="amount" id="amount" placeholder="Enter Amount">
                                                </div>

                                                <div class="col-sm-4 mb-1">
                                                    <input type="date" class="form-control form-control-user" name="valid_date" id="valid_date">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12 mb-1">
                                                    <input type="file" id="your_btn" multiple="multiple" name="project_performance_security_letter[]">
                                                </div>
                                            ...
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-4">
                                                    <button type="button" class="btn btn-primary btn-user btn-block" name="file_upload" id="file_upload">
                                                        <!-- <i class="fab fa-google fa-fw"></i>  -->
                                                        Upload Performance Security Letter
                                                    </button>
        ...
        <div class="card-body bg-custom3">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card bg-custom3">
                        <div class="card-header bg-custom1">
                            <h1 class="h4">Record of Performance Security</h1>
                        </div>
...
<script>
    $('#file_upload').on('click', function() {
        ...
        var officer_name = $('#issued_by').val();
        var project_id = $('#project_id').val();
        var project_allotment_letter = $('#your_btn').val();

        if (valid_date == '') {
            validate = 1;
            $('#valid_date').addClass('red-border');
        }
        ...
        if (validate == 0) {
            $('#add_performance_security_form')[0].submit();
            //  $('#show_error_new').hide();
        } else {
