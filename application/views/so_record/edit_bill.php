                                        ...
                                        <form class="user" role="form" enctype="multipart/form-data" method="post" id="add_bill_form" action="<?= base_url(); ?>SO_RECORD/edit_project_bill">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-1">
                                                    <input type="number" class="form-control form-control-user" value="<?= $project_bills['bill_name'] ?>" name="bill_no" id="bill_no" placeholder="Bill No.">
                                                </div>
                                                <div class="col-sm-6 mb-1">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-1">
                                                    <input type="number" class="form-control form-control-user" name="WD_bill" id="WD_bill" value="<?= $project_bills['wd_in_bill'] ?>" placeholder="WD in the Bill">
                                                </div>
                                                <div class="col-sm-6 mb-1">
                                                    <input type="number" class="form-control form-control-user" value="<?= $project_bills['rm_deducted'] ?>" name="RM_deducted" id="RM_deducted" placeholder="R/M Deducted">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6 mb-1">
                                                    <input type="number" class="form-control form-control-user" name="cheque_number" value="<?= $project_bills['cheque_no'] ?>" id="cheque_number" placeholder="Enter Cheque No">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-1">
                                                    <input type="date" class="form-control form-control-user" value="<?= $project_bills['date_added'] ?>" name="date" id="date" placeholder="Bill Date">
                                                </div>
                                                <div class="col-sm-6 mb-1">
                                                    <input type="number" class="form-control form-control-user" value="<?= $project_bills['it_deducted'] ?>" name="it_deducted" id="it_deducted" placeholder="IT Deducted">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-1">
                                                    <input type="number" class="form-control form-control-user" value="<?= $project_bills['contract_amount'] ?>" name="contract_amt" id="contract_amt" placeholder="Contract Amount">
                                                </div>
                                                <div class="col-sm-6 mb-1">
                                                    <input type="number" class="form-control form-control-user" name="last_bill_paid" value="<?= $project_bills['paid_till_last_bill'] ?>" id="last_bill_paid" placeholder="Amount Paid till Last Bill">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-1">
                                                    <input type="number" class="form-control form-control-user" value="<?= $project_bills['claim_amount'] ?>" name="claim_amt" id="claim_amt" placeholder="Claimed Amount">
                                                </div>
                                                <div class="col-sm-6 mb-1">
                                                    <input type="number" class="form-control form-control-user" name="verify_amt" value="<?= $project_bills['verified_amount'] ?>" id="verify_amt" placeholder="Verfied Amount">
                                                </div>
                                            </div>
